...
Welcome to the JBL Lab Portfolio! This repository contains a comprehensive collection of 8 IT security and infrastructure labs, covering essential topics from infrastructure fundamentals to advanced security implementations.
...
📄 **[View Lab Report](./lab%201/Exploring%20the%20Seven%20Domains)**
...
This collection demonstrates expertise in:
- **IT Infrastructure** - Understanding and documenting infrastructure domains
- **Data Protection** - Backup, recovery, and encryption strategies
- **Security Analysis** - Attack vector assessment and vulnerability identification
- **Security Implementation** - Monitoring, logging, and policy development
- **Network Security** - Packet analysis and traffic monitoring
